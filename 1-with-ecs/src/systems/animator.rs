#![allow(unused_imports, unused_variables)] //TODO(BONUS#3): remove this line

use specs::{System, SystemData, Entities, ReadStorage, WriteStorage, Join, World, prelude::ResourceId};

//TODO(BONUS#3): You will need to import some things.
...
pub struct AnimatorData<'a> {
    //TODO(BONUS#3): You will need this in order to add or remove components from a component storage.
    // HINT: Need to use `&*entities` - https://slide-rs.github.io/specs/08_join.html#basic-joining
    entities: Entities<'a>,
    //TODO(BONUS#3): Which components do you think you need to implement this system?
...
impl<'a> System<'a> for Animator {
    ...
    fn run(&mut self, data: Self::SystemData) {
        ...
        //TODO(BONUS#3): Implement this part of the animation engine.
