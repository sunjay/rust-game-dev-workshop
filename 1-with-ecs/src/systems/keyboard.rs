#![allow(unused_imports)] //TODO(BONUS#3): remove this line
...
pub struct KeyboardData<'a> {
    //TODO(BONUS#3): What data do you need to implement this system?
    // HINT: https://slide-rs.github.io/specs/06_system_data.html
    // HINT: https://slide-rs.github.io/specs/04_resources.html
    #[allow(dead_code)] //TODO(BONUS#3): This field is not needed. It is just a placeholder.
...
impl<'a> System<'a> for Keyboard {
    ...
    fn run(&mut self, data: Self::SystemData) {
        //TODO(BONUS#3): Update the player's velocity based on the keyboard event.
